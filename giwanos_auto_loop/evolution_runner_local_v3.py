...
print(f"🧬 [GIWANOS 진화 루프 v3.0 시작] {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
...
steps = [
    ...
    ("Slack 자동 회고 응답", "./auto_response_slack.py"),
    ("🧠 Self Reflect 루프", "./self_reflect_loop.py")
]

for name, script in steps:
    run(name, script)

print(f"✅ GIWANOS 진화 루프 v3.0 완료")